...
ddi <- read_ipums_ddi("/media/corey/extra//tx_education/usa_00069.xml")
...
sub <- filter(data, birthyr %in% 1980:1998, year %in% 2014:2016,  gq != 3, gq != 4, gq!=6)
save(sub, file="~/OneDrive - University of Texas at San Antonio/tx_education/ipums_subset.Rdata")
rm(data)
gc()
...
Prepare variables:
```{r}
load("/media/corey/extra//tx_education/ipums_subset.Rdata")
...
stargazer(fit, type = "html", style="default", out="~/OneDrive - University of Texas at San Antonio/tx_education/paalogregoutput.html", t.auto = F, p.auto = F, ci=T,
